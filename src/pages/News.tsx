    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold mb-8 dark:text-white">Automotive News</h1>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              <p className="text-xl text-gray-600 dark:text-gray-300">No news found. Check back later for updates.</p>
            </div>
          )}

          <div className="bg-primary rounded-xl p-8 mb-16">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold text-white mb-2">Breaking News</h2>
              <p className="text-white/90">Subscribe to receive the latest automotive news</p>
            </div>
            <NewsletterSignup />
          </div>
        </div>
